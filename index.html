...
<body>
    <header>
        <nav>
            <div class="row">
                ...
                <img src="resources/img/logo.png" alt="omnifood logo-black" class="logo-black">
        ...
        <div class="hero-text-box">
            <h1>Goodbye junk.<br>Hello super healthy meals.</h1>
    ...
    <section class="section-meals">
        <ul class="meals-showcase clearfix">
            ...
            <li>
                <figure class="meal-photo">
                    <img src="resources/img/5.jpg" alt="Paleo beff steak with vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2 steps-box">
                <!-- had to add steps-box here to line up correctly -->
                ...
                <div class="works-step">
                    <div>2</div>
                    <p>Order your delicious meal using our modile app or website. Or you can even call us!</p>
                </div>
                <div class="works-step">
                    <div>3</div>
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            ...
            <div class="col span-1-of-4 box">
                <img src="resources/img/san-francisco.jpg" alt="SanFran">
                <h3>San Francisco</h3>
                <div class="city-feature">
                    <i class="ion-ios-people icon-small"></i> 1600+ happy eaters
                </div>
                ...
                <form method="post" action="mailer.php" class="contact-form">
                  <div class="row">
                    ...
                    <?php
                      ...
                      if($_GET['success'] == -1) {
                        echo "<div class=\"form-messages error\">ERROR!  Please, try again.</div>"
                      }
                    ?>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDa1WgqnUnRhTGhw_KYcLAlQxaI-pPmrII"></script>
